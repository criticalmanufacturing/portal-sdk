...
public class AppUninstallationHandler(
    ISession session,
    ICustomerPortalClient customerPortalClient,
    IDeploymentProgressTrackerFactory deploymentProgressTrackerFactory
) : AbstractHandler(session, true), IAppUninstallationHandler
{
