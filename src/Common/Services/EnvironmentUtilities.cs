...
{
    public class EnvironmentUtilities : IEnvironmentUtilities
    {
        private readonly ISession _session;
        private readonly ICustomerPortalClient _customerPortalClient;

        public EnvironmentUtilities(ISession session, ICustomerPortalClient customerPortalClient)
        {
            _session = session;
        ...
        public async Task<CustomerEnvironment> GetLastNonNotDeployedCustomerEnvironmentVersion(string customerEnvironmentName)
        {
            ...
            {
                EntityTypeName = "CustomerEnvironment",
                Name = "GetLastNonNotDeployedEnvironment",
                Query = new Query()
            };
            query.Query.Distinct = false;
            query.Query.Filters = new FilterCollection() {
