...
Commands:
  ...
  - <a href="#createinfrastructurefromtemplate">```createinfrastructurefromtemplate```</a> - Creates a customer Infrastructure from a Template
...
### createinfrastructurefromtemplate

Creates a customer Infrastructure from a Template

Equivalent to the Powershell cmdlet <a href="#new-infrastructurefromtemplate">New-InfrastructureFromTemplate</a>

Usage: ```cmf-portal createinfrastructurefromtemplate [options]```

Options:
  - ```-v, --verbose``` - Show detailed logging
  - ```-n, --name <name>``` - The name of the Customer Infrastructure to be created
  - ```-t, --template-name <template-name>``` - **REQUIRED** - The name of the Customer Infrastructure template that the new Customer Infrastructure will derive from
...
Options:
  ...
  - ```-trg, --target <AzureKubernetesServiceTarget|dockerswarm|KubernetesOnPremisesTarget|OpenShiftOnPremisesTarget|portainer>``` - **REQUIRED** - Name of the Deployment Target to use for the Customer Environment [default: dockerswarm]
  - ```-template, --template-name <template-name>``` - Name of an existing Customer Environment template that is linked to the Customer Infrastructure
...
Cmdlets:
  ...
  - <a href="#new-infrastructurefromtemplate">```New-InfrastructureFromTemplate```</a> - Creates a customer Infrastructure from a Template
...
Options:
  ...
  - ```-DeploymentTargetName <AzureKubernetesServiceTarget|dockerswarm|KubernetesOnPremisesTarget|OpenShiftOnPremisesTarget|portainer>``` - **REQUIRED** - Name of the Deployment Target to use for the Customer Environment [default: dockerswarm]
  - ```-TemplateName <template-name>``` - Name of an existing Customer Environment template that is linked to the Customer Infrastructure
...
### New-InfrastructureFromTemplate

Creates a customer Infrastructure from a Template

Equivalent to the console command <a href="#createinfrastructurefromtemplate">createinfrastructurefromtemplate</a>

Usage: ```New-InfrastructureFromTemplate [options]```

Options:
  - ```-Name <name>``` - The name of the Customer Infrastructure to be created
  - ```-TemplateName <template-name>``` - **REQUIRED** - The name of the Customer Infrastructure template that the new Customer Infrastructure will derive from
  - ```-IgnoreIfExists``` - Flag that ignores a throw if an error of type 'Customer Infrastructure already exist' occurs
