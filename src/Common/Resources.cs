namespace Cmf.CustomerPortal.Sdk.Common
{
    public class Resources
    {
        ...
        public const string DEPLOYMENT_INTERACTIVE = "Flag that controls if the user should be prompted to go to the portal to initialize the installation manually";
